test_that("functions_bgs.R works", {
    ...
    yn_g_y <- bppd(0, y, samples)

    # l <- 100
    # grid <- seq(-3, 3, length.out = l)
    # vals <- rep(0, l)
    # for (i in 1:l) {
    #     vals[i] <- fmmppd(grid[i], y, samples)
    # }
    # plot(x = grid, y = vals)
    #---------------------------------------------------------------------------------------
    #---------------------------------------------------------------------------------------
...
# test_that("functions_cgs.R works", {
#     source("../../R/functions_cgs.R")
#     #source("R/functions_cgs.R")
#     library(testthat)
#     # tests:
#
#     # test for c_cgs:
#     z <- sample(1:3, 100, replace = T, prob = c(.3, .3, .4))
#     mu <- c(0, -2, 2)
#     sig <- c(1, .1, .5)
#     y <- rep(0, 100)
#     for (i in 1:100) {
#         y[i] <- rnorm(1, mean = mu[z[i]], sd = sig[z[i]])
#     }
#     al <- 1
#     a_mu <- 0
#     kap <- 1
...
#     burnin <- 10
#     num_samples <- 10
#     c_cgs(y, al, a_mu, kap, a_tau, b_tau, burnin, num_samples)
#
#     # test for c_update_s:
#     s <- c(1, 1, 3, 3, 5)
#     y <- c(2, 2, 4, 1, 3)
...
#     a_tau <- 1
#     b_tau <- 1
#     print(c_update_s(s, y, al, a_mu, kap, a_tau, b_tau))
#
#     # test for c_get_full_s_i_prob:
#     s <- c(1, 1, 3, 3, 5)
#     y <- c(2, 2, 4, 1, 3)
#     i <- 3
#     al <- 1
...
#     a_tau <- 1
#     b_tau <- 1
#     p <- c_get_full_s_i_prob(y, s, i, al, a_mu, kap, a_tau, b_tau)
#     print(p)
#     c_check_length(p, 4)
#     expect_equal(sum(p), 1)
#
#     # test for c_get_part_s_i_prob:
#     s <- c(1, 1, 3, 3, 5)
#     n <- 5
#     s_ni <- c(1, 1, 3, 5)
#     al <- 1
#     k <- length(unique(s_ni))
#     p <- c_get_part_s_i_prob(n, s_ni, al)
#     c_check_length(p, k+1)
#     expect_equal(sum(p), 1)
#
#     # test for c_get_part_y_i_prob:
#     y_i <- 3
#     y_ni <- c(2, 2, 1, 3)
#     s <- c(1, 1, 3, 3, 5)
#     n <- 5
...
#     a_tau <- 1
#     b_tau <- 1
#     p <- c_get_part_y_i_prob(y_i, y_ni, s_ni, a_mu, kap, a_tau, b_tau)
#     c_check_length(p, k+1)
#     expect_equal(sum(p), 1)
#
#     # test for c_check_length:
#     x <- c(1, 2, 3)
#     y <- numeric(0)
#     expect_error(c_check_length(x, 3), NA)
#     expect_error(c_check_length(y, 0), NA)
# })
